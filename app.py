...
def predict(text):
    with open(r'C:\\Users\\Andrey\\OneDrive\\Desktop\\Fake-News-Detection\\ML\\vectorizer.pk', 'rb') as vectorizerFile:
        vectorizer = pickle.load(vectorizerFile)
    with open(r'C:\\Users\\Andrey\\OneDrive\\Desktop\\Fake-News-Detection\\ML\\pac_model.pk', 'rb') as pacFile:
        pac_model = pickle.load(pacFile)
    with open(r'C:\\Users\\Andrey\\OneDrive\\Desktop\\Fake-News-Detection\\ML\\mnb_model.pkl', 'rb') as mnbFile:
